...
<%
	...
	try{
		...
		String sql = "SELECT mno, date_format(m.rdate, '%Y-%m-%d') as rdate, nickname, hit, title, content, link FROM music_board m INNER JOIN user u ON m.uno = u.uno WHERE mno = ?";
...
%>
	        ...
	        <div class="contentBtn">
	            <button>저장</button>
				<button type="button" onclick="location.href='view.jsp?mno=<%= mno %>'">취소</button>
	        </div>
        </form>
    </section>
    <footer>
