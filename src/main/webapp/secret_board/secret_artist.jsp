...
<%
	...
	try{
		...
		String sqlTotal ="SELECT COUNT(*) AS total FROM artist_board a INNER JOIN user u ON a.uno = u.uno WHERE open = 'S' OR u.state = 'D'";
		...
		String sql = "SELECT ano, title, nickname, date_format(a.rdate, '%Y-%m-%d') as rdate, hit FROM artist_board a INNER JOIN user u ON a.uno = u.uno WHERE open = 'S' OR u.state = 'D'"; 
...
%>
    ...
    <section>
        <div class="topBtn">
            <form action="secret_artist.jsp" method="get">
