...
%>
    ...
    <section>
        ...
        <table>
            ...
            <tr>
            	<td colspan="2" style="text-align: center;"><%= content.replace("\n","<br>") %></td>
            </tr>
        </table>
<%
		// 관리자만 글 수정, 삭제 버튼 보이기
...
%>
	        <div class="contentBtn">
	             <button onclick="location.href='secret_notice_modify.jsp?nno=<%= nno %>'">수정</button>
	             <button onclick="document.deleteForm.submit();">삭제</button>
	        	 <button onclick="location.href='secret_notice.jsp'">목록 보기</button>
	             <form name="deleteForm" action="secret_notice_deleteOk.jsp" method="post">
