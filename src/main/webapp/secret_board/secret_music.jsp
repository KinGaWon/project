...
<%
	...
	try{
		...
		String sqlTotal ="SELECT COUNT(*) AS total FROM music_board m INNER JOIN user u ON m.uno = u.uno WHERE open = 'S' OR u.state = 'D'";
		...
		String sql = "SELECT mno, title, nickname, date_format(m.rdate, '%Y-%m-%d') as rdate, hit FROM music_board m INNER JOIN user u ON m.uno = u.uno WHERE open = 'S' OR u.state = 'D'"; 
...
%>
    ...
    <section>
        <div class="topBtn">
            <form action="secret_music.jsp" method="get">
