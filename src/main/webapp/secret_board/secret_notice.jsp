...
<%
	...
	try{
		...
		String sqlTotal ="SELECT COUNT(*) AS total FROM notice_board n INNER JOIN user u ON n.uno = u.uno WHERE open = 'S' OR u.state = 'D'";
		...
		String sql = "SELECT nno, title, nickname, date_format(n.rdate, '%Y-%m-%d') as rdate, hit, authorization FROM notice_board n INNER JOIN user u ON n.uno = u.uno WHERE open = 'S' OR u.state = 'D'"; 
...
%>
    ...
    <section>
        <div class="topBtn">
            <form action="secret_notice.jsp" method="get">
